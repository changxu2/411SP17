      ...
      <div class="col-6">
        ...
        <ul class="list-group">
          ...
          for ($i = 0; $i < $count; $i++) {
            ...
            echo ("<li class=\"list-group-item active\">".$result_row->title."<button type=\"button\" onclick=\"jumpEdit(this.id)\" id = \"".$to_find."\" class=\"btn btn-secondary btn-sm editPlan\">Edit Plan</button>
      <button type=\"button\" class=\"btn btn-primary btn-sm deletePlan\">Delete Plan</button></li>");
          ...
          if (isset($_POST['addTrip'])){
            if(!empty($_POST['addTrip'])){
              ...
              echo ("<li class=\"list-group-item active\">New Plan<button type=\"button\" onclick=\"jumpEdit(this.id)\" id = \"".$newPlanId."\" class=\"btn btn-secondary btn-sm editPlan\">Edit Plan</button>
        <button type=\"button\" class=\"btn btn-primary btn-sm deletePlan\">Delete Plan</button></li>");
            }
          }
          ?>
